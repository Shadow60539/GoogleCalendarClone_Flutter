...
class CalendarThreeDayPage extends StatefulWidget {
  @override
  State createState() => _CalendarThreeDayPageState();
}

class _CalendarThreeDayPageState extends State<CalendarThreeDayPage> {
  @override
      ...
      builder: (context, state) {
        return Scaffold(
            ...
            body: DaysPageView(
              ...
              controller: state.threeDaysPageController,
