...
class CalendarDayPage extends StatefulWidget {
  @override
  State createState() => _CalendarDayPageState();
}
                              ...
                              EventViewComponent(
                                getEventsOfDay: (day) {
                                  ...
                                  if (_cachedAppointments[day] == null) {
                                    final List<StartDurationItem> _cacheWidget =
                                        state.appointments
                                            .where((element) {
                                              return element.start.day ==
                                                      day.day &&
                                                  element.start.month ==
                                                      day.month &&
                                                  element.start.year ==
